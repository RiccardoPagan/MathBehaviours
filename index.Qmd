...
In the second session, participants will complete a set of 30 operations with 3 possible choices (skip, help and solve independently). All tasks will be administered in small groups via computer in the classroom (see Figure 1a, 1b, and 2). 
...
**RQ2:** To what extent do trait-and-state level math attitudes (math anxiety, academic buoyancy, math avoidance, math self-competence, and worry) predict students’ math behaviours (skipping, help-seeking, self-reliance behaviours) during the mathematical task?
